...
set "NOVEL_DEV=data/emotion/dialogue-stage-20260915-v5-final-41764/dev.jsonl"
set "NOVEL_TEST=data/emotion/dialogue-stage-20260915-v5-final-41764/test.jsonl"
