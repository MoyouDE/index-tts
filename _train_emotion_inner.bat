...
set "NOVEL_TRAIN=data/emotion/dialogue-stage-20260907-v1/train.jsonl"
set "NOVEL_DEV=data/emotion/dialogue-stage-20260907-v1/dev.jsonl"
set "NOVEL_TEST=data/emotion/dialogue-stage-20260907-v1/test.jsonl"
set "OUTPUT_DIR=outputs/emotion-data/macbert-training-dialogue-stage-20260907-v1"
